...
for password in passwordList:
    ...
    firstCharacter = int(passwordSplit[0].split('-')[0]) - 1
    secondCharacter = int(passwordSplit[0].split('-')[1]) - 1
    searchCharacter = passwordSplit[1].replace(':', '')
    searchText = passwordSplit[2]
    if (len(searchText) - 1) >= secondCharacter:
        if searchText[firstCharacter] == searchCharacter and searchText[secondCharacter] != searchCharacter:
            truePasswords += 1
        elif searchText[firstCharacter] != searchCharacter and searchText[secondCharacter] == searchCharacter:
            truePasswords +=1
