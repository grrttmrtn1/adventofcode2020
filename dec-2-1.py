...
for password in passwordList:
    ...
    rangeBegin = int(passwordSplit[0].split('-')[0])
    rangeEnd = int(passwordSplit[0].split('-')[1])
    searchCharacter = passwordSplit[1].replace(':', '')
    searchText = passwordSplit[2]
    if searchText.count(searchCharacter) <= rangeEnd and searchText.count(searchCharacter) >= rangeBegin:
        truePasswords += 1
